...
Перед установкой необходимо клонировать Helper-project на свой компьютер. Папку, в которой находится файл setup.py, переименовать в helper. Далее в командной стороке набрать следующую команду:
pip install абсолютный*путь*к_папке_helper
